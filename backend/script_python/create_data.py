...
lyon_network_parameters = {
    ...
    "network_type" : "walk",
    "bbox": None,
    "output_file": data_folder_path+ "osm/lyon_walk.gpkg"
}
...
merge_network_data(data_folder_path + "osm/lyon_walk.gpkg", "./backend/script_python/data/raw_data/joined_if_3946.gpkg", data_folder_path + "osm/weighted_network_walk.gpkg")
