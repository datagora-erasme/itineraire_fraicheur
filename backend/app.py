...
network_path = "./data/osm/final_network_iflen.gpkg"
network_pickle_path = "./data/final_network_iflen.pickle"
network_multidigraph_pickle_path ="./data/final_network_iflen.pickle"
