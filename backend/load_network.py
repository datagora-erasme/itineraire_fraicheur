...
def load_network(network_path, pickle_path, network_multidigraph_pickle_path):
    ...
    new_edges = gdf_edges[["u", "v", "key", "osmid", "length", "from", "to", "score_distance", "total_score", "freshness_score", "score_distance_prop", "exp_distance","exp_fresh_score", "geometry"]].set_geometry("geometry")
