...
network_path = "./data/osm/final_veget_temp_graph.gpkg"
network_pickle_path = "./data/final_veget_temp_graph.pickle"
network_multidigraph_pickle_path ="./data/final_veget_temp_graph_multidigraph.pickle"
